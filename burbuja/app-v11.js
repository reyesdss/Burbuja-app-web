...
function syncMobileViewport(resetBaseline=false){
  ...
  else viewportBaseline=Math.max(viewportBaseline,h);
  document.documentElement.style.setProperty("--app-height",`${h}px`);
  const keyboardOpen=!!vv && viewportBaseline-h>110;
...
// v11 evita registrar un Service Worker dentro de /burbuja/.
