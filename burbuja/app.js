...
function showLoginScreen(){
  // 1. Mostrar Login primero: ninguna limpieza puede impedir la navegación visual.
  showScreen("auth");
  switchAuthTab("login");

  // 2. Invalidar cualquier trabajo asíncrono de la sesión anterior.
  bumpSessionGeneration();
  setForceLogin(true);

  // 3. Limpiar el estado de forma segura. Si alguna parte falla, Login ya está visible.
  try{
    clearVisualSession();
    updateAuthActionButtons();
  }catch(e){
    console.warn("Error seguro durante la limpieza de sesión:",e);
  }

  // 4. Enfocar el usuario después del renderizado.
