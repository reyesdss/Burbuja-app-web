...
const BURBUJA_VERSION = "responsive-safe-refactor-20260919";
...
async function bootAccount(user) {
  ...
  if(saved&&savedMeta?.id===saved){
    ...
    // La interfaz ya está lista; validar/sincronizar en segundo plano sin espera artificial.
...
function wireRealtime() {
  ...
  // Las suscripciones secundarias no deben esperar cientos de milisegundos.
  void Promise.resolve().then(loadExtras);
}
